    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog {...offspring[0]} eyeColor={this.state.eyeColor} />
          {/*<BabyHog id={offspring[0].id} name={offspring[0].name} hobby={offspring[0].hobby} eyeColor={this.state.eyeColor} /> */}
          <BabyHog {...offspring[1]} eyeColor={this.state.eyeColor} />
          <BabyHog {...offspring[2]} eyeColor={this.state.eyeColor} />
        </ul>
